...
<div class="modal-dialog modal-xl" role="document">
  <div class="modal-content border-0">
        ...
        <div class="col-sm-8">
          ...
          <div class="row gx-2">
            <div class="mb-3 col-md-6">
              ...
              <input v-model="temp.category"
                     type="text" class="form-control" id="category"
                     placeholder="請輸入分類">
            </div>
            <div class="mb-3 col-md-6">
              <label for="price" class="form-label">單位</label>
              <input v-model="temp.unit"
          ...
          <div class="row gx-2">
            <div class="mb-3 col-md-6">
              ...
              <input v-model="temp.origin_price"
                      type="number" class="form-control" id="origin_price"
                      placeholder="請輸入原價">
            </div>
            <div class="mb-3 col-md-6">
              <label for="price" class="form-label">售價</label>
              <input v-model="temp.price"
          ...
          <div class="mb-3">
            ...
            <textarea v-model="temp.description"
                      type="text" class="form-control" id="description"
                      placeholder="請輸入產品描述"></textarea>
          </div>
          <div class="mb-3">
            <label for="content" class="form-label">說明內容</label>
            <textarea v-model="temp.content"
    ...
    <div class="modal-footer">
      ...
      <button @click="$emit('emit-updateGoods',temp)"
...
export default {
  ...
  methods: {
    ...
    uploadImage () {
      const imgData = this.$refs.fileInput.files[0]
      const formData = new FormData()
      formData.append('fileData', imgData)
